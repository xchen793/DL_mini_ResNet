...
# How to run the code
* You can either download the project1_model.py and run it via VScode or terminal. If run by terminal, go to the folder where the project1_model.py is downloaded and then use the command line here: python './project1_model.py' 
...
* If you want to use the checkpoint, please uncommet the line 208 - line 211 (where you shouuld see we load the PATH there), and comment the line 206 (net = resnet18().to(device)).
